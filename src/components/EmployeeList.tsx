...
const EmployeeList = () =>{
    ...
    const dataSearch = employees.filter(emp => {
        const filterSearch = emp.id.toString().includes(search) ||
    ...
    const columns: TableProps<Employee>['columns'] = [
        ...
        },
        {
            ...
            render:(_,value)=>{
                let color;
                value.title==="Frontend Dev"? color="red": 
                value.title==="Backend Dev"? color="green":
                value.title==="UI/UX Designer"? color="volcano": color="gold";
                return (
                    <Tag color={color}>{value.title}</Tag>
                )
            }
        },
        {
    ...
    return (
        <>
            ...
            <EmployeeCard isOpenEmployee={isOpenEmployee} setOpenEmployee={setOpenEmployee} idEmployee={isIdEmployee}/>
        </>
    )
}
